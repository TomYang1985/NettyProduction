...
import com.elvishew.xlog.util.FileUtil;
...
public class FilePrinter implements Printer {
    ...
    void doPrintln(int logLevel, String tag, String msg) {
        ...
        if (lastFileName == null || fileNameGenerator.isFileNameChangeable()) {
            ...
            //根据时间每次生成新的文件名，对比是否是同一天
            if ((!TextUtils.isEmpty(lastFileName) && !new File(lastFileName).exists()) || !newFileName.equals(lastFileName)) {
                if (writer.isOpened()) {
                    writer.close();
                }
