...
public class Logger {
    ...
    public void d(String tag, String msg){
        ...
        if(printer instanceof PrinterSet) {
            for (Printer item : ((PrinterSet) printer).printers) {
                if (item instanceof FilePrinter) {
                    item.println(logLevel, tag, msg);
                } else {
                    androidLog(item, logLevel, msg, tag);
                }
            }
        }else {
            if (printer instanceof FilePrinter) {
                ...
                androidLog(printer, logLevel, msg, tag);
            }
        }
    }
    ...
    private void androidLog(Printer printer, int logLevel, String msg, String tag){
